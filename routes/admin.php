...
/// advertising image---------------------------------------------
    ...
    Route::get('/advertise/edit/{id}', 'AdvertisingController@edit')->name('advertise.edit');
    Route::post('/advertise/update', 'AdvertisingController@Update')->name('advertise.update');
	// Route::post('/flash_deals/update_status', 'AdvertisingController@update_status')->name('flash_deals.update_status');
	// Route::post('/flash_deals/update_featured', 'AdvertisingController@update_featured')->name('flash_deals.update_featured');
	// Route::post('/flash_deals/product_discount', 'AdvertisingController@product_discount')->name('flash_deals.product_discount');
	// Route::post('/flash_deals/product_discount_edit', 'AdvertisingController@product_discount_edit')->name('flash_deals.product_discount_edit');
