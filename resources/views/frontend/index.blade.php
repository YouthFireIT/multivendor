    ...
    <section class="home-banner-area mb-4">
        <div class="container-fluid">
            <div class="row no-gutters position-relative">
               ...
               @php
                  $advertise_img = \App\AdvertisingModel::find(1);  
               @endphp
            
                <div class="col-lg-2 d-block pl-4">
                   
                    <div class="img">
                        <img class="lazyload img-fit" style="height:275px;" src="{{ asset('public/frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($advertise_img->image) }}" alt="">
                    </div>     
...
<div class="container">
    ...
    <div class="row"> 
        @foreach (\App\Category::where('category_mall','=','1')->limit(4)->get() as $key => $category)
        <div class="col-md-3 float-left">
                 <a href="{{ route('products.category', $category->slug) }}">
                     <div class="card p-2 shadow-lg" style="border-radius: 20px;">
                <div class="text-wrap">
                    <img src="{{ my_asset($category->icon) }}" data-src="{{ my_asset($category->icon) }}" class="rounded-circle bg-red" width="30" height="30"   alt="{{ translate('All Category') }}" alt="..."> 
                    <strong class="font-weight-bold ml-1">{{ __($category->name) }}</strong><span class="fa fa-chevron-right float-right pt-2"></span></div>
                 </div></a>
          </div>
     @endforeach
