...
<!-- 
    ...
    <section class="mt-5 mb-5">
        ...
        top: -4%;" src="{{ asset('alibaba') }}/images/shipping (1).png" alt=""> Free Shipping</a>
                ...
                <div class="col-lg-2 mr-4 shadow-sm" style=""> <a href="{{route('grocery')}}" style="color: black;font-size: 13px;font-weight: 500;font-size: 15px;"> <img class="img-fluid" style="width: 30px; position: relative; 
        top: -4%;" src="{{ asset('alibaba') }}/images/shipping (3).png" alt=""> Grocery</a> </div>
                <div class="col-lg-2 mr-4 shadow-sm" style=""> <a href="{{route('dora.mall')}}" style="color: black;font-size: 13px;font-weight: 500;font-size: 15px;"> <img class="img-fluid" style="width: 30px; position: relative; top: -4%;" src="{{ asset('alibaba') }}/images/shipping (2).png" alt=""> Dora Mall</a> </div>
