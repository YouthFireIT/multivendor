    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label">{{translate('Enable Mall category')}}</label>
                    <div class="col-sm-8 input-group-prepend">
                      <div class="input-group-text">
                        <input type="checkbox"  @if ($category->category_mall == '1') checked  @endif class="p-3" name="category_mall" aria-label="Checkbox for following text input" value="1">
                      </div>
